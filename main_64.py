...
def main():
    ...
    # 64 colors for 8 bits per pixel output image
    palette = octree.make_palette(64)

    # create palette for 64 color max and save to file
    ...
    palette_out.save('D_palette_64.png')
